  ...
  return (
    <>
      ...
      <div className="chatbot-modal">
        <div className="chatbot-header">
          ...
          <div className="chatbot-header-actions">
            ...
            <button 
              ...
              className="btn-header-action"
              aria-label="Choisir modèle IA"
              title="Choisir modèle IA"
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        ...
        {/* Modal sélecteur de modèle */}
        {showModelSelector && (
          <div className="model-selector-modal">
            <div className="model-selector-header">
              <h3>Choisir un modèle IA</h3>
              <button onClick={() => setShowModelSelector(false)} className="btn-close-selector">×</button>
            </div>
            <div className="model-selector-list">
              {AI_MODELS.map(model => (
                <button
                  key={model.id}
                  className={`model-option ${(currentChat?.model || selectedModel) === model.id ? 'selected' : ''}`}
                  onClick={() => {
                ...
                >
                  ...
                  {(currentChat?.model || selectedModel) === model.id && (
